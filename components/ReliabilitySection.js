...
const ReliabilitySection = () => {
  return (
    <section className="relative w-full px-4 md:px-10 lg:px-20 -mt-10 md:-mt-20 lg:-mt-32 pb-10 z-20"> 
  ...
  {/* lg:w-[554px] ko hata kar max-w-[554px] kar diya hai */}
  <h2 className="text-white text-3xl md:text-4xl lg:text-[38px] w-full max-w-[554px] font-bold leading-tight">
    We Provide Trusty Feedback You Can Rely On
  </h2>
  
  <p className="w-full max-w-[554px] text-white/80 lg:text-[16px] md:text-base">
